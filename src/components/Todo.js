...
import { useDeleteTodoMutation, useUpdateTodoMutation, useUpdateColorMutation, useUpdateStatusMutation } from "../features/api/apiSlice";
...
export default function Todo({ todo }) {
    ...
    return (
        <div className="flex justify-start items-center p-2 hover:bg-gray-100 hover:transition-all space-x-4 border-b border-gray-400/20 last:border-0">
            ...
            >
                {state.status === 'saved' ? state.text : (
                    <form
                        className="flex items-center bg-gray-100 px-2 py-2 rounded-md"
